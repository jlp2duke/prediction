...
# save workspace
filen<-paste("ch7computing_survBayes_t",seed,".RData",sep="")
save.image(file=filen)

## integrating all results across random starts
# 20 runs
load("/Users/jclarke/Documents/predictive/Book/ch7/uissurv/ch7computing_survBayes_t10010.RData")
FPE1bc3<-FPE
modPH1bc3<-modPH
medPH1bc3<-medPH
# 20 runs each
load("/Users/jclarke/Documents/predictive/Book/ch7/uissurv/ch7computing_survBayes_t21012.RData")
FPE2bc3<-FPE
modPH2bc3<-modPH
medPH2bc3<-medPH
load("/Users/jclarke/Documents/predictive/Book/ch7/uissurv/ch7computing_survBayes_t21112.RData")
FPE3bc3<-FPE
modPH3bc3<-modPH
medPH3bc3<-medPH
load("/Users/jclarke/Documents/predictive/Book/ch7/uissurv/ch7computing_survBayes_t21122.RData")
FPE4bc3<-FPE
modPH4bc3<-modPH
medPH4bc3<-medPH
load("/Users/jclarke/Documents/predictive/Book/ch7/uissurv/ch7computing_survBayes_t31122.RData")
FPE5bc3<-FPE
modPH5bc3<-modPH
medPH5bc3<-medPH
# 
...
for(i in 1:nperm2) FPEavgbc3<-FPEavgbc3+FPE1bc3[[i]]$bayes2
for(i in 1:nperm2) FPEavgbc3<-FPEavgbc3+FPE2bc3[[i]]$bayes2
for(i in 1:nperm2) FPEavgbc3<-FPEavgbc3+FPE3bc3[[i]]$bayes2
for(i in 1:nperm2) FPEavgbc3<-FPEavgbc3+FPE4bc3[[i]]$bayes2
for(i in 1:nperm2) FPEavgbc3<-FPEavgbc3+FPE5bc3[[i]]$bayes2
FPEavgbc3<-FPEavgbc3/nperm
FPEsdbc3<-c(rep(0,npred))
for(i in 1:nperm2) FPEsdbc3<-FPEsdbc3+(FPEavgbc3-FPE1bc3[[i]]$bayes2)^2
for(i in 1:nperm2) FPEsdbc3<-FPEsdbc3+(FPEavgbc3-FPE2bc3[[i]]$bayes2)^2
for(i in 1:nperm2) FPEsdbc3<-FPEsdbc3+(FPEavgbc3-FPE3bc3[[i]]$bayes2)^2
for(i in 1:nperm2) FPEsdbc3<-FPEsdbc3+(FPEavgbc3-FPE4bc3[[i]]$bayes2)^2
for(i in 1:nperm2) FPEsdbc3<-FPEsdbc3+(FPEavgbc3-FPE5bc3[[i]]$bayes2)^2
FPEsdbc3<-sqrt(FPEsdbc3/(nperm-1))
plot(1:npred,FPE1bc3[[1]]$bayes2, type="l", xlab='time step', ylab='L1 cumulative predictive error', col='grey75', cex.lab=1.2, cex.axis=1.2, cex=1.2, ylim=c(0,17000))
lines(1:npred,FPE2bc3[[2]]$bayes2, type="l", col='grey75') 
lines(1:npred,FPEavgbc3, type="l", col='black')
lines(1:npred,FPEavgbc3-2*FPEsdbc3, type="l", lty=2)
lines(1:npred,FPEavgbc3+2*FPEsdbc3, type="l", lty=2)
# save as bayCPE-c3-PH_v2.pdf

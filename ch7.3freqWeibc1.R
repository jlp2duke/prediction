...
#save.image('ch7computing_freqWc1_31122.RData')
#save.image('ch7computing_freqWc1_21122.RData')
#save.image('ch7computing_freqWc1_21112.RData')
#save.image('ch7computing_freqWc1_21012.RData')
save.image('ch7computing_freqWc1_10010.RData')

## integrating results across permutations; load each workspace, save FPE results
# 20 runs
load("/Users/jclarke/Documents/predictive/Book/ch7/uissurv/ch7computing_freqWc1_10010.RData")
FPE1wc1<-FPE
modPH1wc1<-modPH
medPH1wc1<-medPH
# 20 runs each
load("/Users/jclarke/Documents/predictive/Book/ch7/uissurv/ch7computing_freqWc1_21012.RData")
FPE2wc1<-FPE
modPH2wc1<-modPH
medPH2wc1<-medPH
load("/Users/jclarke/Documents/predictive/Book/ch7/uissurv/ch7computing_freqWc1_21112.RData")
FPE3wc1<-FPE
modPH3wc1<-modPH
medPH3wc1<-medPH
load("/Users/jclarke/Documents/predictive/Book/ch7/uissurv/ch7computing_freqWc1_21122.RData")
FPE4wc1<-FPE
modPH4wc1<-modPH
medPH4wc1<-medPH
load("/Users/jclarke/Documents/predictive/Book/ch7/uissurv/ch7computing_freqWc1_31122.RData")
FPE5wc1<-FPE
modPH5wc1<-modPH
medPH5wc1<-medPH
# 
...
npred<-80
#
FPEavgfwc1<-c(rep(0,npred))
for(i in 1:nperm2) FPEavgfwc1<-FPEavgfwc1+FPE1wc1[[i]]$freq
for(i in 1:nperm2) FPEavgfwc1<-FPEavgfwc1+FPE2wc1[[i]]$freq
for(i in 1:nperm2) FPEavgfwc1<-FPEavgfwc1+FPE3wc1[[i]]$freq
for(i in 1:nperm2) FPEavgfwc1<-FPEavgfwc1+FPE4wc1[[i]]$freq
for(i in 1:nperm2) FPEavgfwc1<-FPEavgfwc1+FPE5wc1[[i]]$freq
FPEavgfwc1<-FPEavgfwc1/nperm
FPEsdfwc1<-c(rep(0,npred))
for(i in 1:nperm2) FPEsdfwc1<-FPEsdfwc1+(FPEavgfwc1-FPE1wc1[[i]]$freq)^2
for(i in 1:nperm2) FPEsdfwc1<-FPEsdfwc1+(FPEavgfwc1-FPE2wc1[[i]]$freq)^2
for(i in 1:nperm2) FPEsdfwc1<-FPEsdfwc1+(FPEavgfwc1-FPE3wc1[[i]]$freq)^2
for(i in 1:nperm2) FPEsdfwc1<-FPEsdfwc1+(FPEavgfwc1-FPE4wc1[[i]]$freq)^2
for(i in 1:nperm2) FPEsdfwc1<-FPEsdfwc1+(FPEavgfwc1-FPE5wc1[[i]]$freq)^2
FPEsdfwc1<-sqrt(FPEsdfwc1/(nperm-1))
plot(1:npred,FPE1wc1[[1]]$freq, type="l", xlab='time step', ylab='L1 cumulative predictive error')
lines(1:npred,FPE2wc1[[2]]$freq, type="l", col='red') 
lines(1:npred,FPEavgfwc1, type="l", col='blue')
lines(1:npred,FPEavgfwc1-2*FPEsdfwc1, type="l", lty=2, col='green')
lines(1:npred,FPEavgfwc1+2*FPEsdfwc1, type="l", lty=2, col='green')
